...
def main():
    ...
    print(f'新闻项: {len(data_loader.news)}')
    print(f'类别数: {len(data_loader.categories)}')
    print(f'有效用户: {len(data_loader.users)}')
